...
* **Conceitos Aplicados:** Game Loop, renderização baseada em matrizes (Tilemap), colisão lógica por grid, interpolação de movimento suave e animação de sprites orientada a tempo (`sf::Clock`).
